...
public String find_07a(String phrase) {
    ...
    for (int i = 0; i < len; i++) {
        ...
        double idf = Math.log10(N / (double) tdf); // can be computed earlier
    ...
    for (int i = 0; i < N; i++) {
        sortedScore.insertScoreRecord(new ScoreRecord(scores[i], sources.get(i).getURL(), sources.get(i).getTitle(), sources.get(i).getDesc()));
    }

    return sortedScore.printScores(); //the top 10 limitation is edited in the printScores method
}
/////---------------------------------
public void searchLoop() {
    ...
    public void store(String storageName) {
        try {
            String pathToStorage = "/home/ehab/tmp11/rl/"+storageName; //edit this to your path
